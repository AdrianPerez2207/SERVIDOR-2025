                        ...
                        <div class="card-body">
                            <form role="form" class="text-start" action="controlador.php" method="post">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    ...
                                    <input name="password" type="password" class="form-control" pattern="(?=.*[A-Z]).{8,}" required
                                           title="min. 8 caracteres/ 1 mayúscula">
                                </div>
                                ...
                                <a href="login.php" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
                                    ¿Tienes una cuenta? Accede aquí</a>
                                <div class="text-center">
                                    <button type="submit" name="formRegistro" class="btn bg-gradient-primary w-100 my-4 mb-2">Crear Usuario</button>
                                </div>
                            </form>
                        </div>
                    </div>
