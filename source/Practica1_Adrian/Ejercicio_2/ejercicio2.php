...
<body>
    <div class="bg-secondary-subtle">
        <header>
            <h1 class="p-3 ms-5">LIBRERÍA JAROSO</h1>
        </header>
        <main>
            <?php
                $libros = array(
                ...
                function pintarLibros($libros, $categoria){
                    $contador = 0;
                    echo "<h2 class='text-start p-3 text-primary'>$categoria</h2>";
                        ...
                        foreach($libros as $libro){
                            if($libro["categoria"] == $categoria) {
                                echo "<div class='col border border-black p-2 bg-white'>";
                                    ...
                                    echo "<p class='mt-3'>Precio: {$libro["precio"]}</p>";
                                echo "</div>";
                                $contador++;
                            }
                            if($contador == 4){
        ...
        <footer class="p-5">
            <strong>Realizado por: ADRIÁN PÉREZ SÁNCHEZ</strong>
        </footer>
    </div>
